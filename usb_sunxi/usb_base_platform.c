...
extern volatile int sunxi_usb_auto_burn_from_boot_init;
extern void set_usb_auto_burn_boot_init_flag(int flag );
#endif
...
void sunxi_usb_irq(void *data)
{
	...
	if(misc_irq & USBC_INTUSB_SOF)
	{
        ...
        #ifdef CONFIG_AUTO_BURN
          set_usb_auto_burn_boot_init_flag(1);
        #endif
...
#ifdef CONFIG_AUTO_BURN
extern int sunxi_handshake_main(void  *buffer);
int sunxi_usb_burn_loop(void)
{
	return sunxi_handshake_main(&sunxi_ubuf);
}
#endif
