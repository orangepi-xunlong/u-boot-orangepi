...
extern struct _nand_info* NandHwInit_v2(int process);
extern int NandHwExit(void);
extern uint32 nftl_write_end(void);
...
//    ClearNandStruct();
	...
	nand_phy_info = NandHwInit_v2(NAND_IN_UBOOT);
...
//    ClearNandStruct();
	...
	nand_info = NandHwInit_v2(NAND_IN_UBOOT);
