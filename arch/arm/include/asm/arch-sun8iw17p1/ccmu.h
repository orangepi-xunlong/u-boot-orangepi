...
#define CCMU_PLL_C0_CPUX_CTRL_REG           CCMU_PLL_CPUX_CTRL_REG
#define CCMU_PLL_C1_CPUX_CTRL_REG           (SUNXI_CCM_BASE + 0x08)
...
#define CCMU_C0_CPUX_AXI_CFG_REG            CCMU_CPUX_AXI_CFG_REG
#define CCMU_C1_CPUX_AXI_CFG_REG            (SUNXI_CCM_BASE + 0x504)
...
#define CCMU_CCI400_CFG_GREG                (SUNXI_CCM_BASE + 0x530)
