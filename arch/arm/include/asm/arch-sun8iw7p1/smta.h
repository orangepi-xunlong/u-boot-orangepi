...
#define SMTA_STATUS_REG(n)      (SUNXI_SMTA_BASE + (n) * 0x0C + 0x04)
#define SMTA_SET_REG(n)         (SUNXI_SMTA_BASE + (n) * 0x0C + 0x08)
#define SMTA_CLEAR_REG(n)       (SUNXI_SMTA_BASE + (n) * 0x0C + 0x0C)
