...
#define   PMU_IC_TYPE					BOOT_POWER22_VERSION
#define   PMU_POWER_DISABLE_DOWN		BOOT_POWER22_OFF_CTL
#define   PMU_IRQ_STATU1				BOOT_POWER22_INTSTS4
#define   PMU_IRQ_STATU2				BOOT_POWER22_INTSTS5
