...
static_assert(
	sizeof(struct bootloader_message) == 2048,
...
bool read_bootloader_message_from(bootloader_message *boot,
				  const std::string &misc_blk_device,
				  std::string *err);
...
bool read_wipe_package(std::string *package_data, size_t size,
		       std::string *err);
