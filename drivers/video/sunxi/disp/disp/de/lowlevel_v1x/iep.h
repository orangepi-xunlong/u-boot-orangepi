...
enum __iep_drc_mode_t {
	IEP_DRC_MODE_UI,
	IEP_DRC_MODE_VIDEO,
};

struct __disp_frame_info_t {
...
extern __s32 IEP_Drc_Set_Reg_Base(__u32 sel, uintptr_t base);
...
extern __s32 IEP_Drc_Set_Mode(__u32 sel, enum __iep_drc_mode_t mode);
...
/* drc wb */
extern __s32 WB_EBIOS_Set_Reg_Base(__u32 sel, uintptr_t base);
...
extern __s32 WB_EBIOS_Set_Para(__u32 sel,
			       disp_size insize, disp_window cropwin,
			       disp_window outwin, disp_fb_info outfb);
...
/* sat */
extern __s32 SAT_Set_Reg_Base(__u32 sel, uintptr_t base);
