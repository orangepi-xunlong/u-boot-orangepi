...
void hdmi_clk_enable_correct(void)
{
	...
	if (clk_rate == 27000) {
		*((u32 *)(0x03001048)) = 0x81006200;
		*((u32 *)(0x03001148)) = 0xc3a00f5c;
		*((u32 *)(0x03001b00)) = 0x8300030a;
		*((u32 *)(0x03001b1c)) = 0x00030001;
		*((u32 *)(0x03001b80)) = 0x8300030a;
		*((u32 *)(0x03001348)) = 0x0;
	} else if (clk_rate == 74250) {
		*((u32 *)(0x03001048)) = 0x81006200;
		*((u32 *)(0x03001148)) = 0xc3a00f5c;
		*((u32 *)(0x03001b00)) = 0x83000207;
		*((u32 *)(0x03001b1c)) = 0x00030001;
		*((u32 *)(0x03001b80)) = 0x83000207;
		*((u32 *)(0x03001348)) = 0x0;
	} else if (clk_rate == 148500) {
		*((u32 *)(0x03001048)) = 0x81006200;
		*((u32 *)(0x03001148)) = 0xc3a00f5c;
		*((u32 *)(0x03001b00)) = 0x8200000f;
		*((u32 *)(0x03001b1c)) = 0x00030001;
		*((u32 *)(0x03001b80)) = 0x8300000f;
		*((u32 *)(0x03001348)) = 0x0;
	} else if (clk_rate == 297000) {
		*((u32 *)(0x03001048)) = 0x81003000;
		*((u32 *)(0x03001148)) = 0xc070fae1;
		*((u32 *)(0x03001b00)) = 0x82000001;
		*((u32 *)(0x03001b1c)) = 0x00030001;
		*((u32 *)(0x03001b80)) = 0x83000003;
		*((u32 *)(0x03001348)) = 0x0;
	} else if (clk_rate == 594000) {
		*((u32 *)(0x03001048)) = 0x81003000;
		*((u32 *)(0x03001148)) = 0xc070fae1;
		*((u32 *)(0x03001b00)) = 0x82000001;
		*((u32 *)(0x03001b1c)) = 0x00030001;
