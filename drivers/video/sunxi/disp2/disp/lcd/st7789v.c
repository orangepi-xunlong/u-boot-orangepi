...
#if 0
static void st7789v_spi_data(u8 value)
{
	int n;
...
static void st7789v_write_spi_16bit(u16 value)
{
	spi_cs_0;
	st7789v_spi_data((value>>8) & 0xff);
	st7789v_spi_data((value>>0) & 0xff);
	spi_cs_1;
}
#endif
static void LCD_panel_init(u32 sel)
...
static void lcd_panel_st7789v_init(void)
{
	...
	sunxi_lcd_delay_ms(100);/* Delay 10ms, This delay time is necessary */
	sunxi_lcd_gpio_set_value(0, 0, 1);
	sunxi_lcd_delay_ms(200);/* Delay 120 ms */
	...
	st7789v_spi_write_data(0x01);/* VDV and VRH Command Enable */
	...
	st7789v_spi_write_cmd(0x21);/* Exit Sleep */
